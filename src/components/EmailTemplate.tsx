        ...
        >
          ...
          <div style={{ padding: "40px 30px" }}>
            ...
            <p style={{ fontSize: "16px", marginBottom: "25px" }}>
              Thank you for your purchase! Your high-resolution race photos are
            ...
            >
              ...
              <p style={{ margin: "5px 0", fontSize: "14px" }}>
                <strong>Photos:</strong> {photoCount} high-resolution image
                {photoCount > 1 ? "s" : ""}
              </p>
              <p style={{ margin: "5px 0", fontSize: "14px" }}>
            ...
            >
              <p style={{ margin: "0", fontSize: "14px", color: "#92400e" }}>
                <strong>📎 Your photos are attached as a ZIP file</strong>
                <br />
                Download and extract the ZIP file to access your high-resolution
                images.
              </p>
            </div>
          ...
          >
            ...
            >
              This email was sent to you because you purchased race photos for
              bib #{bibNumber}.
            </p>
          </div>
        </div>
